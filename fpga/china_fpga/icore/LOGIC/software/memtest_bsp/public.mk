...
JDI_FILE := E:/casdev/fpgaproj/china_fpga/icore/LOGIC/ICORE.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := E:/casdev/fpgaproj/china_fpga/icore/LOGIC/icore_nios.sopcinfo
...
# Design Name 
# setting SOPC_NAME is icore_nios
SOPC_NAME := icore_nios
...
# The SOPC System ID 
# setting SOPC_SYSID is 2345
SOPC_SYSID_FLAG += --id=2345
ELF_PATCH_FLAG  += --id 2345

# The SOPC System ID Base Address 
# setting SOPC_SYSID_BASE_ADDRESS is 0x1002010
SOPC_SYSID_FLAG += --sidp=0x1002010
ELF_PATCH_FLAG  += --sidp 0x1002010

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1497253607
SOPC_SYSID_FLAG += --timestamp=1497253607
ELF_PATCH_FLAG  += --timestamp 1497253607
