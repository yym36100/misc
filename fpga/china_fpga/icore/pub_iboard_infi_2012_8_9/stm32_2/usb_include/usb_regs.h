...
#define ENDP0   ((unsigned char)0)
#define ENDP1   ((unsigned char)1)
#define ENDP2   ((unsigned char)2)
#define ENDP3   ((unsigned char)3)
#define ENDP4   ((unsigned char)4)
#define ENDP5   ((unsigned char)5)
#define ENDP6   ((unsigned char)6)
#define ENDP7   ((unsigned char)7)
/******************************************************************************/
...
/* Exported macro ------------------------------------------------------------*/
/* SetCNTR */
#define _SetCNTR(wRegValue)  (*CNTR   = (unsigned short int)wRegValue)

/* SetISTR */
#define _SetISTR(wRegValue)  (*ISTR   = (unsigned short int)wRegValue)

/* SetDADDR */
#define _SetDADDR(wRegValue) (*DADDR  = (unsigned short int)wRegValue)

/* SetBTABLE */
#define _SetBTABLE(wRegValue)(*BTABLE = (unsigned short int)(wRegValue & 0xFFF8))

/* GetCNTR */
#define _GetCNTR()   ((unsigned short int) *CNTR)

/* GetISTR */
#define _GetISTR()   ((unsigned short int) *ISTR)

/* GetFNR */
#define _GetFNR()    ((unsigned short int) *FNR)

/* GetDADDR */
#define _GetDADDR()  ((unsigned short int) *DADDR)

/* GetBTABLE */
#define _GetBTABLE() ((unsigned short int) *BTABLE)

/* SetENDPOINT */
#define _SetENDPOINT(bEpNum,wRegValue)  (*(EP0REG + bEpNum)= \
    (unsigned short int)wRegValue)

/* GetENDPOINT */
#define _GetENDPOINT(bEpNum)        ((unsigned short int)(*(EP0REG + bEpNum)))
...
#define _SetEPTxStatus(bEpNum,wState) {\
    register unsigned short int _wRegVal;       \
...
* Return         : status .
*******************************************************************************/
#define _GetEPTxStatus(bEpNum) ((unsigned short int)_GetENDPOINT(bEpNum) & EPTX_STAT)

#define _GetEPRxStatus(bEpNum) ((unsigned short int)_GetENDPOINT(bEpNum) & EPRX_STAT)
...
* Return         : None.
*******************************************************************************/
#define _GetEPAddress(bEpNum) ((unsigned char)(_GetENDPOINT(bEpNum) & EPADDR_FIELD))

#define _pEPTxAddr(bEpNum) ((unsigned long int *)((_GetBTABLE()+bEpNum*8  )*2 + PMAAddr))
#define _pEPTxCount(bEpNum) ((unsigned long int *)((_GetBTABLE()+bEpNum*8+2)*2 + PMAAddr))
#define _pEPRxAddr(bEpNum) ((unsigned long int *)((_GetBTABLE()+bEpNum*8+4)*2 + PMAAddr))
#define _pEPRxCount(bEpNum) ((unsigned long int *)((_GetBTABLE()+bEpNum*8+6)*2 + PMAAddr))
...
*******************************************************************************/
#define _GetEPTxAddr(bEpNum) ((unsigned short int)*_pEPTxAddr(bEpNum))
#define _GetEPRxAddr(bEpNum) ((unsigned short int)*_pEPRxAddr(bEpNum))
...
#define _BlocksOf32(dwReg,wCount,wNBlocks) {\
    ...
    if((wCount & 0x1f) == 0)\
      wNBlocks--;\
    *pdwReg = (unsigned long int)((wNBlocks << 10) | 0x8000);\
  }/* _BlocksOf32 */
...
#define _BlocksOf2(dwReg,wCount,wNBlocks) {\
    ...
    if((wCount & 0x1) != 0)\
      wNBlocks++;\
    *pdwReg = (unsigned long int)(wNBlocks << 10);\
  }/* _BlocksOf2 */

#define _SetEPCountRxReg(dwReg,wCount)  {\
    unsigned short int wNBlocks;\
...
#define _SetEPRxDblBuf0Count(bEpNum,wCount) {\
    unsigned long int *pdwReg = _pEPTxCount(bEpNum); \
...
#define _SetEPRxCount(bEpNum,wCount) {\
    unsigned long int *pdwReg = _pEPRxCount(bEpNum); \
    _SetEPCountRxReg(pdwReg, wCount);\
  }
/*******************************************************************************
...
*******************************************************************************/
#define _GetEPTxCount(bEpNum)((unsigned short int)(*_pEPTxCount(bEpNum)) & 0x3ff)
#define _GetEPRxCount(bEpNum)((unsigned short int)(*_pEPRxCount(bEpNum)) & 0x3ff)
...
#define _SetEPDblBuf0Count(bEpNum, bDir, wCount)  { \
    ...
    {_SetEPRxDblBuf0Count(bEpNum,wCount);} \
      ...
      /* IN endpoint */ \
      *_pEPTxCount(bEpNum) = (unsigned long int)wCount;  \
  } /* SetEPDblBuf0Count*/
...
#define _SetEPDblBuf1Count(bEpNum, bDir, wCount)  { \
    ...
    {_SetEPRxCount(bEpNum,wCount);}\
      ...
      /* IN endpoint */\
      *_pEPRxCount(bEpNum) = (unsigned long int)wCount; \
  } /* SetEPDblBuf1Count */
...
/* External variables --------------------------------------------------------*/
extern volatile unsigned short int wIstr;  /* ISTR register last read value */
...
void FreeUserBuffer(unsigned char bEpNum/*bEpNum*/, unsigned char bDir);
unsigned short int ToWord(unsigned char, unsigned char);
unsigned short int ByteSwap(unsigned short int);
