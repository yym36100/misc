			...
			{	   
				...
				case ensin:
					...
					for(u16 i=0;i<length;i++) 
					{
						...
						//pdata[i] += offs + (a/0.25) * (rand()-32767.0/2.0)/32768.0;
		...
		public:
			...
			void DrawCursor(void) 
			{
				if(Highlighted)				
				{
					...
					surf->DrawVLine(lastevent.x,rect.y,rect.h+rect.y,0xffff8080);
					surf->DrawHLine(rect.x,rect.x+rect.w,lastevent.y,0xffff8080);
