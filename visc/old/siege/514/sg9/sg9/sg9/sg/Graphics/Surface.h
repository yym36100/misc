...
namespace sg{
	namespace gr{
		...
		public:
			...
			void DrawRect2(u16 x1, u16 y1, u16 x2, u16 y2) {
				DrawVLineP(x1,y1,y2);
				DrawVLineP(x2,y1,y2);
			...
			void DrawRect2P(u16 x1, u16 y1, u16 x2, u16 y2) {
				DrawVLine(x1,y1,y2);
				DrawVLine(x2,y1,y2);
			...
			u32 Blend(u32 f, u32 b, double a) {
				...
				res.r = (u8)(a*(cf.r-cb.r) + cb.r);
				res.g = (u8)(a*(cf.g-cb.g) + cb.g);
				res.b = (u8)(a*(cf.b-cb.b) + cb.b);
				res.a = cf.a;
				return res.c;
			}

			void DrawLine(double x1,double y1,double x2,double y2) {
				DrawLine((u16)x1,(u16)y1,(u16)x2,(u16)y2);
			}
