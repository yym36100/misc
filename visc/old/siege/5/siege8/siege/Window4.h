...
namespace siege{
	...
	public:
			...
			:mode(1),pause(0),sigt(widgets::CSignal::ensin)
		{
			...
			gw3 = new widgets::CGraphWidget(surf,200,10+200+200+20+20,1400,200);
			widgetlist->Add(gw3);
			gw4 = new widgets::CGraphWidget(surf,200,10+200+200*2+20*2+20,1400,200);
			widgetlist->Add(gw4);
...
//				int fix_fftr(short f[], int m, int inverse);
				...
				((widgets::CGraphWidget*)(gw1->next))->sig = new widgets::CSignal(0,0,0,0,sss/2,siege::widgets::CSignal::enext,ff);
				...
				((widgets::CGraphWidget*)(gw1->next->next))->sig = new widgets::CSignal(0,0,0,0,sss/2,siege::widgets::CSignal::enext,myf);
				//1 input format adaptation
				// reuse prev data
				...
				((widgets::CGraphWidget*)(gw1->next->next->next))->sig = new widgets::CSignal(0,0,0,0,sss/2,siege::widgets::CSignal::enext,myf2);
		...
		virtual LRESULT CALLBACK WndProc(UINT Msg,WPARAM wParam, LPARAM lParam)
		{
			...
			case WM_TIMER:
					...
					delete ((widgets::CGraphWidget*)(gw1->next))->sig;
				{
					...
					char buffer[100];
					//CSignal(float a = 80, float f = 2, float ph =3.14/3.0,float offs = 0,u16 l = 50, tsig sig = ensin):
					gw1->sig = new widgets::CSignal(1000,freq,0.0,0,sss*1,sigt);
					freq+=1.1;
					if(freq>sss/2)freq = 0.1;
					fft();
